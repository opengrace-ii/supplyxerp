...
-- Core Ledger Table: Inventory Events
-- Partitioned by time (month) in a real deployment
CREATE TABLE IF NOT EXISTS inventory_events (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY,
  tenant_id BIGINT REFERENCES tenants(id),
  event_type TEXT NOT NULL CHECK (event_type IN ('GR','GI','MOVE','QC','ADJUST','COUNT','SPLIT_DEBIT','SPLIT_CREDIT','CONSUME','PUTAWAY','HU_MOVED')),
...
INSERT INTO products (id, tenant_id, code, name, base_unit)
  ...
  ON CONFLICT DO NOTHING;
INSERT INTO handling_units (id, tenant_id, product_id, location_id, code, quantity, unit)
  VALUES (1,1,1,2,'HU-1001',315,'KG'),(2,1,2,3,'HU-1002',21.16,'IMP')
  ON CONFLICT DO NOTHING;
