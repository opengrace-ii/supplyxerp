...
type HandlingUnit struct {
	...
	RollPrefix   pgtype.Text        `json:"roll_prefix"`
	RollSequence pgtype.Int4        `json:"roll_sequence"`
}
...
type Product struct {
	...
	MaterialCategory          pgtype.Text        `json:"material_category"`
	ProductGroup              pgtype.Text        `json:"product_group"`
	PlanningMethod            pgtype.Text        `json:"planning_method"`
	MinLotSize                pgtype.Numeric     `json:"min_lot_size"`
	MaxLotSize                pgtype.Numeric     `json:"max_lot_size"`
	PlannedDeliveryDays       pgtype.Int4        `json:"planned_delivery_days"`
	InHouseLeadDays           pgtype.Int4        `json:"in_house_lead_days"`
	PurchaseUnit              pgtype.Text        `json:"purchase_unit"`
	GrProcessingDays          pgtype.Int4        `json:"gr_processing_days"`
	BatchTracked              pgtype.Bool        `json:"batch_tracked"`
	StorageConditions         pgtype.Text        `json:"storage_conditions"`
	ShelfLifeDays             pgtype.Int4        `json:"shelf_life_days"`
	MinRemainingShelfLifeDays pgtype.Int4        `json:"min_remaining_shelf_life_days"`
	SalesUnit                 pgtype.Text        `json:"sales_unit"`
	MinOrderQuantity          pgtype.Numeric     `json:"min_order_quantity"`
	AvailabilityCheck         pgtype.Text        `json:"availability_check"`
}
...
type VZoneStock struct {
	...
	SiteCode      string      `json:"site_code"`
	TenantID      int64       `json:"tenant_id"`
	ProductCount  interface{} `json:"product_count"`
	HuCount       interface{} `json:"hu_count"`
