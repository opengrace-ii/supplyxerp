...
type BuildOrder struct {
	...
	OutputMaterialID  pgtype.Int8        `json:"output_material_id"`
	OutputDescription pgtype.Text        `json:"output_description"`
	...
	ProductionZone    pgtype.Text        `json:"production_zone"`
	OutputZone        pgtype.Text        `json:"output_zone"`
...
type BuildOrderComponent struct {
	ID            int64          `json:"id"`
...
type BuildOrderIssue struct {
	ID            int64              `json:"id"`
	BuildOrderID  int64              `json:"build_order_id"`
	ComponentSeq  int32              `json:"component_seq"`
	HuCode        pgtype.Text        `json:"hu_code"`
	MaterialID    pgtype.Int8        `json:"material_id"`
	IssuedQty     pgtype.Numeric     `json:"issued_qty"`
	UnitOfMeasure pgtype.Text        `json:"unit_of_measure"`
	IssuedBy      pgtype.Text        `json:"issued_by"`
...
type BuildOrderOutput struct {
	...
	OutputHuCode pgtype.Text        `json:"output_hu_code"`
	OutputZone   pgtype.Text        `json:"output_zone"`
...
type QualityCheckFinding struct {
	...
	FindingNo        int32          `json:"finding_no"`
